            ...
            .data = self.addExtraAssumeCapacity(Instruction.BrCond{
                ...
                .weights = switch (weights) {
                    ...
                    .then_likely, .else_likely => w: {
                        ...
                        const unlikely_const = try self.builder.debugConstant(try self.builder.intConst(.i32, 1));
                        const likely_const = try self.builder.debugConstant(try self.builder.intConst(.i32, 2000));
