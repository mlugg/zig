...
pub const FuncGen = struct {
    ...
    fn airSwitchBr(self: *FuncGen, inst: Air.Inst.Index) !Builder.Value {
        ...
        const weights: Builder.Function.Instruction.BrCond.Weights = weights: {
            ...
            weights[0] = try o.builder.debugConstant(try o.builder.intConst(.i32, else_weight));
            ...
            while (it.next()) |case| {
                ...
                const weight_meta = try o.builder.debugConstant(try o.builder.intConst(.i32, weight_val));
